      ...
      if (selectedpromotion) {
        setSelectedpromotions((prevSelected) => [
          ...prevSelected,
          {
            ...
            klist_id: selectedpromotion.klaviyo_audience_list_id,
          },
        ]);
      }
    }
  ...
  return (
    ...
    >
        ...
        <View border="none" padding="none">
          ...
          >
            <Image
                  ...
                  borderWidth="none"
                  borderRadius="none"
                  source={"https://crosspromotion.24livehost.com/public/backend/app/header.png"}
                  fit="contain"
                  viewportSize="small"
                  resolution="1"
                  description="ABOUT BUY WOMEN BUILT"
      ...
      <Form onSubmit={() => console.log("onSubmit event")}>
        ...
        <BlockSpacer spacing="tight" />
        <View padding="tight" border="none" size="extraSmall">
          <Checkbox
            id="checkbox1"
