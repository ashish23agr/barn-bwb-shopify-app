...
function App() {
  ...
  return (
    <BlockStack
      ...
      background="subdued"
    >
      <Grid columns={["5%", "fill", "5%"]} spacing="loose" border="base" background="base" padding="tight">
      ...
      <Form onSubmit={() => console.log("onSubmit event")}>
        <BlockStack spacing="loose">
          ...
          >
            {promotions.map((promotion, index) => (
              <View border="base" padding="tight" key={promotion.id} background="base">
                <View padding="none">
                ...
                <Badge iconPosition="end" size="base" tone="critical">{promotion.badge}</Badge>
                <BlockSpacer spacing="tight" />
        ...
        <View padding="none" border="none" size="extraSmall">
          <Checkbox id="checkbox1" name="checkboxchoices" onChange={() => termCheckboxChange()}>
        ...
        <Grid columns={["70%", "fill"]} spacing="tight">
          <View>
            <TextField label="Email" value={emailValue} onInput={handleEmailValue} />
          </View>
          <Button
