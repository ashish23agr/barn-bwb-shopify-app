...
function App() {
  ...
  const handleAddToList = async () => {
    console.log('Length : '+selectedpromotions.length + ' emailValue : ' + emailValue);
    ...
    try {
      const response = await fetch('https://crosspromotion.24livehost.com/api/shop/signup', {
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
            Authorization:
  ...
  return (
    ...
    >
      ...
      <Form onSubmit={() => console.log("onSubmit event")}>
              ...
              >
                <View padding="none">
                  ...
                  <Link
                    ...
                    inlineAlignment="left"
                    overlay={
                      <Modal id="learnmore-modal" padding title={promotion.title}>
                        <InlineLayout
                          spacing="loose"
                          columns={["30%", "50%"]}
                          blockAlignment="left"
        ...
        <BlockSpacer spacing="tight" />
        <Grid columns={["56%", "fill"]} spacing="tight">
          <View>
            <TextField
              label="Email"
              value={emailValue}
